 ...
 * 
 * What is this interface? Think of it like a digital PC storage system from the
 * Pokémon games.
 * 
 * Just as the PC in Pokémon games lets trainers store, organize, and retrieve
 * their
 * captured Pokémon, this repository helps the application find and manage all
 * the
...
public interface UserPokemonRepository extends JpaRepository<UserPokemon, Long> {
    ...
    /**
     * Find a specific Pokémon owned by a user.
     * 
     * Like asking "Does Ash have a Pikachu?".
     */
    List<UserPokemon> findByUserIdAndPokemonId(Long userId, Long pokemonId);
}
